...
/**
 * Fetch all neighborhoods and set thei r HTML.
 */
fetchNeighborhoods = () => {
    DBHelper.fetchNeighborhoods((error, neighborhoods) => {
        if (error) { // Got an error
            console.log("Error (fetchNeighborhoods): "+error);
        } else {
...
fetchCuisines = () => {
    DBHelper.fetchCuisines((error, cuisines) => {
        if (error) { // Got an error!
            console.log("Error (fetchCuisines): "+error);
        } else {
...
updateRestaurants = () => {
    ...
    DBHelper.fetchRestaurantByCuisineAndNeighborhood(cuisine, neighborhood, favourite, (error, restaurants) => {
        if (error) { // Got an error! omg
            console.log("Error (updateRestaurants): "+error);
        } else {
...
createRestaurantHTML = (restaurant, tabIndex) => {
    ...
    btn.setAttribute('class', 'restaurant-favorite-btn');
